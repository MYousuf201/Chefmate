...
class _AddRecipeScreenState extends State<AddRecipeScreen> {
  ...
  Future<void> _save() async {
    ...
    if (_pickedImage != null) {
      ...
      try {
        ...
        imageUrl = await RecipeService().uploadImage(bytes, fileName: fileName);
      } catch (e) {
        if (!mounted) return;
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: (rp.isLoading || _uploadingImage) ? null : _save,
                  child: (rp.isLoading || _uploadingImage)
  ...
  Widget _buildImagePicker() {
    final existingUrl = ApiConfig.resolveImageUrl(_uploadedImageUrl);
    Widget imageWidget;
    if (_pickedImage != null) {
      ...
      imageWidget = Column(
        ...
        children: [
          ...
          Text('Tap to select photo', style: TextStyle(color: Colors.grey[500])),
        ],
      );
    }
    ...
    return Column(
      ...
      children: [
        const Text('Recipe Photo', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
        const SizedBox(height: 8),
        GestureDetector(
          onTap: _pickImage,
          child: Container(
