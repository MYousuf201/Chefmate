...
class _SmartSearchScreenState extends State<SmartSearchScreen> {
  ...
  Widget _buildSmartImage(String? imageUrl) {
    final imgUrl = ApiConfig.resolveImageUrl(imageUrl);
  ...
  Widget _buildResultCard(Map<String, dynamic> json, RecipeProvider rp) {
    ...
    return Card(
      ...
      child: InkWell(
        ...
        onTap: () => Navigator.of(context).pushNamed('/recipe-detail', arguments: {
          'id': json['id'],
          'missingIngredients': json['missingIngredients'],
        }),
        child: Padding(
              ...
              Stack(
                children: [
                  ClipRRect(
                    ...
                    child: SizedBox(
                      width: 80, height: 80,
                      child: _buildSmartImage(json['image_url']?.toString()),
                    ),
                  ),
                  Positioned(
                    top: 4, right: 4,
