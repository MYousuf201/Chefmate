...
class RecipeService {
  ...
  Future<void> addLike(int recipeId, String type) async {
    await _api.post('/recipes/$recipeId/likes', body: {'like_type': type});
  }
  ...
  Future<void> addRating(int recipeId, {
    ...
    await _api.post('/recipes/$recipeId/ratings', body: {
      'rating': rating,
      'tried_it': triedIt,
      if (review != null && review.isNotEmpty) 'review_comment': review,
    });
  }
  ...
  Future<RecipeComment> addComment(int recipeId, String text, {int? parentCommentId}) async {
    final body = <String, dynamic>{'comment_text': text};
  ...
  Future<void> addCommentLike(int commentId, String type) async {
    await _api.post('/recipes/comments/$commentId/likes', body: {'like_type': type});
  }
