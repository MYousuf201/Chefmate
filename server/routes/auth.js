...
router.put('/preferences', authenticateToken, async (req, res) => {
  try {
    ...
    console.log('Updating preferences:', { dietary_restrictions, allergies, preferred_cuisines });
...
router.post('/avatar', authenticateToken, async (req, res) => {
  try {
    ...
    const avatarUrl = `https://ui-avatars.com/api/?name=${encodeURIComponent(req.user.email)}&background=f97316&color=fff&size=150`;
